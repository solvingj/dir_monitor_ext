#ifndef DIR_MANAGER_HPP_
#define DIR_MANAGER_HPP_
...
namespace dir_monitor_ext
{
  ...
  public:
    ...
    dir_manager(const std::string directory, boost::asio::io_service & io_service) :
    ...
    void add_file_monitor(file_monitor fm)
    {
      file_monitors.insert_or_assign(fm.filename, fm);
    }

    void remove_file_monitor(file_monitor fm)
    {
